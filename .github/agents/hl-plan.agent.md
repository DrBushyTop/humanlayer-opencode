...
2. Check if research exists in ` thoughts/research/` (ask user if unsure)
...
3. Generate filename:
   ...
   - Full path: ` thoughts/plans/YYYY-MM-DD-{slug}.md`
...
**Saved to**: ` thoughts/plans/YYYY-MM-DD-{slug}.md`
...
**File**: ` thoughts/plans/YYYY-MM-DD-{slug}.md`
