...
- Fetch external documentation via the `hl-web-search-researcher` subagent (do not call web tools directly)
- Write research documents to ` thoughts/research/`
- Edit research documents for follow-up questions

### What You Cannot Do

- Edit or write files outside of ` thoughts/`
...
3. Generate filename:
   ...
   - Full path: ` thoughts/research/YYYY-MM-DD-{slug}.md`
...
**Saved to**: ` thoughts/research/YYYY-MM-DD-{slug}.md`
